"""
Django settings for tmwebproject project.
...
SECRET_KEY = 'django-insecure-96cxo*2q^dtcj0j$=ny*-@ni60hr!u6(_z=fh_)hy8-+p)0q*v'
...
WSGI_APPLICATION = 'tmwebproject.wsgi.application'
