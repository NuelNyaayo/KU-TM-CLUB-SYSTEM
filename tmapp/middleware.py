...
class LoginRequiredMiddleware:
    ...
    def __call__(self, request):
        ...
        protected_paths = ['/memb_dash', '/memb_roles', '/memb_membership', '/memb_resources', '/memb_notifications', '/memb_elections', '/memb_profile', '/memb_settings', '/memb_contact', '/memb_support']
